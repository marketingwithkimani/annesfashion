...
$supabaseApkUrl = 'https://yteejssnesajnuibfacx.supabase.co/storage/v1/object/public/downloads/AnnesFashionLine.apk';

// If on local XAMPP and file exists, serve directly
$localPath = realpath(__DIR__ . '/../anne-app/AnnesFashionLine.apk');
...
if ($isLocal && $localPath && file_exists($localPath)) {
    ...
    header('Content-Disposition: attachment; filename="AnnesFashionLine.apk"');
